...
export const WagonBlock = ({
  ...
  const distanceToTargetX = 10000 - wagon.x;
  const distanceMoved = 10000 - distanceToTargetX;
  const targetWidth = Math.round(distanceMoved / (10000 / 100));

  const distanceToTargetInMeters = Math.round((10000 - wagon.x) / 30);
