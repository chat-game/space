<template>
  <div class="my-16 px-4 max-w-4xl mx-auto text-center space-y-6">
    ...
    <ActiveCard class="py-4 px-6 grid grid-cols-1 md:grid-cols-3 gap-y-4 md:gap-x-4 items-center justify-center">
      <p class="col-span-2">
